...
def green_movement(pressed_keys, pgreen):               #Rather than going left and right, I can rotate the tank and only go forward and back.
...
def main():
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:               # I can try to make them fire a bullet png instead of a rect.
        ...
        pressed_keys = pygame.key.get_pressed() # If you use "if", then "elif" for conditions; you can't input more than 1 button.
